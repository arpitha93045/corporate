...
import com.corporate.service.AgentTools;
...
public class AgentToolDefinitions {
    ...
    private final com.corporate.service.EnquiryService enquiryService;
    private final ObjectMapper mapper;

    public AgentToolDefinitions(AgentTools tools,
                                DraftCartService draftCartService,
                                com.corporate.service.EnquiryService enquiryService,
                                ObjectMapper mapper) {
        this.tools = tools;
    ...
    public Object invoke(String toolName, JsonNode input) {
        return switch (toolName) {
            ...
            case "create_enquiry" -> {
                ...
                com.corporate.dto.EnquiryRequest req =
                        new com.corporate.dto.EnquiryRequest(
                                name,
                                email,
